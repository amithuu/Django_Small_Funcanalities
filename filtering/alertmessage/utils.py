...
class Send_Notification:
    ...
    password = 'vsjw hlzg zdbk qlul' # ? from gmail u can get it..
    ...
    #     send_email(body='congratulations on Creating the job..', subject='Posted a Job', to='amithkulkarni99@gmail.com')
